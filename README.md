...
3. Paste the Module's [Manifest URL](https://github.com/ceriath/My-Shared-Compendia-CoC7/releases/download/v1.0.0/module.json)
...
- Option 2: Updating your `module.json` file:
  1. Go to the Module's installation folder within foundry (`~/Data/modules/my-shared-compendia-coc`) and update the `module.json` file.
...
- `Skills (shared)` ([Item](https://foundryvtt.com/article/items/))
...
- [CoC7 Game System](https://foundryvtt.com/packages/CoC7) is required: The Game System adds some SRD Compendia.
- Using [Compendium Folders](https://github.com/earlSt1/vtt-compendium-folders) is highly recommended.

# Credits
This is a copy of [stschoelzel/My-Shared-Compendia](https://github.com/stschoelzel/My-Shared-Compendia) that has been modified to work with Call of Cthulhu 7eth Edition
